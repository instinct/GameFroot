...
@implementation GameFrootAppDelegate
...
- (void) applicationDidFinishLaunching:(UIApplication*)application
{
	...
	[Shared setDevice:[hardware platformString]];
...
//		CCLOG(@"Retina Display Not supported");
	...
	/*
	// Fix scaling mode (ideally I would like to remove this and either scale contents or use HD resources)
	// Use only if pixel art
	if (([[hardware platformString] isEqualToString:@"iPhone 4G"])
		|| ([[hardware platformString] isEqualToString:@"iPod Touch 4G"])) {
		// || ([[hardware platformString] isEqualToString:@"iPad"])) { // iPad 4.2 does not work!! images are inverted...
		// || ([[hardware platformString] isEqualToString:@"iPhone 4S""])) { // Not tested on iPhone 4S
		
		// Use for retina display devices and iPad to avoid blurry images
